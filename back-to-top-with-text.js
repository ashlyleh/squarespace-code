/**
 * Back to Top Button with Text & AOS Initialization
 * Centered pill button with "To Top" text label
 * @version 1.0.0
 */
(function() {
  'use strict';
  ...
  function injectHTML() {
    ...
    console.log('Back to Top with Text: HTML injected successfully');
  }
  /**
  ...
  function initBackToTop() {
    ...
    console.log('Back to Top with Text: Initialized successfully');
  }
  /**
  ...
  function initAOS() {
    if (typeof AOS === 'undefined') {
      console.warn('Back to Top with Text: AOS library not loaded');
      return;
    }
    ...
    console.log('Back to Top with Text: AOS initialized successfully');
  }
  /**
